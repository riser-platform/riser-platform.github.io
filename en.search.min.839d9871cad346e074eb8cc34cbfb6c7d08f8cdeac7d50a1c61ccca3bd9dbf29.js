...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f4cad011cde1156bf034e6ca51bda78887325ea890d08dfad48ac273b92aa6fb.js',function(){input.required=false;search();});}
